	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-90 p-b-30">
				 <form method="POST" id="signup-form" class="login100-form validate-form" action="forgot_password.php">
            ...
            <p style="font-size: 12px">We will sent an OTP to this Email</p>
