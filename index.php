	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-90 p-b-30">
				 <form method="POST" id="signup-form" class="login100-form validate-form" action="logincode.php">
        ...
        <td><a href="#" class="select_category" data-type="animals">Animals</a></td>
        ...
        <div>
          ...
          <a href="forgot_password_mail.php" class="txt3 bo1 hov1"><p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspForgot Password<p></a>
